# https://github.com/relwin/NeoPill/blob/main/stripsim.py
"""
stripsim.py
...
class LEDStrip(object):
    ...
    def __init__(self, config_path):
        ...
        self.radius = 0
        self.center = 0
        self.gamma = 0.50 #0.25  # LEDs are much brighter than LCD, smaller gamma=brighter. HW gamma not supported.
        self.frame_size = 0
